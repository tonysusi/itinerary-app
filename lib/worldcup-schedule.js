...
const SCHEDULE = {
  "11 Jun": [
    ...
    { time: "10:00 PM ET", match: "South Korea vs Czechia", venue: "Guadalajara, Mexico" },
  ],
  "12 Jun": [
    { time: "3:00 PM ET", match: "Canada vs Bosnia", venue: "Toronto" },
    { time: "9:00 PM ET", match: "USA vs Paraguay", venue: "Los Angeles" },
  ],
  "13 Jun": [
    { time: "12:00 AM ET", match: "Australia vs Türkiye", venue: "Vancouver" },
  ...
  "14 Jun": [
    ...
    { time: "10:00 PM ET", match: "Tunisia vs Sweden", venue: "Monterrey, Mexico" },
  ],
  "15 Jun": [
  ...
  "16 Jun": [
    ...
    { time: "6:00 PM ET", match: "Norway vs Iraq", venue: "Boston" },
    { time: "9:00 PM ET", match: "Argentina vs Algeria", venue: "Kansas City" },
  ],
  "17 Jun": [
    { time: "1:00 PM ET", match: "Portugal vs DR Congo", venue: "Houston" },
  ...
  "18 Jun": [
    { time: "12:00 PM ET", match: "South Africa vs Czechia", venue: "Atlanta" },
    { time: "3:00 PM ET", match: "Switzerland vs Bosnia", venue: "Los Angeles" },
  ...
  "19 Jun": [
    { time: "12:00 AM ET", match: "Paraguay vs Türkiye", venue: "San Francisco Bay" },
  ...
  "20 Jun": [
    ...
    { time: "1:00 PM ET", match: "Netherlands vs Sweden", venue: "Houston" },
  ...
  "22 Jun": [
    ...
    { time: "5:00 PM ET", match: "France vs Iraq", venue: "Philadelphia" },
  ...
  "23 Jun": [
    ...
    { time: "10:00 PM ET", match: "Colombia vs DR Congo", venue: "Guadalajara, Mexico" },
  ],
  "24 Jun": [
    { time: "3:00 PM ET", match: "Canada vs Switzerland", venue: "Vancouver" },
    { time: "3:00 PM ET", match: "Qatar vs Bosnia", venue: "Seattle" },
    { time: "6:00 PM ET", match: "Scotland vs Brazil", venue: "Miami" },
    { time: "6:00 PM ET", match: "Morocco vs Haiti", venue: "Atlanta" },
    { time: "9:00 PM ET", match: "Mexico vs Czechia", venue: "Mexico City" },
  ...
  "25 Jun": [
    ...
    { time: "7:00 PM ET", match: "Japan vs Sweden", venue: "Dallas" },
    { time: "10:00 PM ET", match: "USA vs Türkiye", venue: "Los Angeles" },
    { time: "10:00 PM ET", match: "Paraguay vs Australia", venue: "San Francisco Bay" },
  ],
  "26 Jun": [
    { time: "3:00 PM ET", match: "Norway vs France", venue: "Boston" },
    { time: "3:00 PM ET", match: "Senegal vs Iraq", venue: "Toronto" },
  ...
  "27 Jun": [
    ...
    { time: "7:30 PM ET", match: "Uzbekistan vs DR Congo", venue: "Atlanta" },
